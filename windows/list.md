...
[FastStone](http://faststone.org/) （[笔记](../faststone/index.md)）
...
- Chrome（[笔记](/chrome/)）
- [Firefox](https://www.mozilla.org/en-US/firefox/all/#zh-CN) （[笔记](/firefox/)）
...
- [Pandoc](https://github.com/jgm/pandoc/releases) 多种格式转换器 （[笔记](../pandoc/index.md)）
...
- [Total Commander](http://www.ghisler.com/) 资源管理器（[笔记](../totalcmd/index.md)）
...
- [Sublime Text 3](http://www.sublimetext.com/3dev)（[笔记](../sublimetext/index.md)）
- [vim](http://www.vim.org/)（[笔记](../vim/index.md)）
- [Notepad++](https://notepad-plus-plus.org/download/)（[笔记](../npp/index.md)）
- [Atom](https://atom.io/)（[笔记](../atom/index.md)）
- [Visual Studio Code](https://code.visualstudio.com/download?insiders=true)（[笔记](../vscode/index.md)）

IDE(integrated development environment)，如名所示，集成编译，调试等功能。

- [Visual Studio Community](https://www.visualstudio.com/downloads/download-visual-studio-vs#d-community)（[笔记](../vs/index.md)）
- [WebStorm](https://www.jetbrains.com/webstorm/)（[笔记](../webstorm/index.md)）
...
- [ConEmu](https://github.com/Maximus5/ConEmu/releases)（[笔记](../conemu/index.md)）
- [msys2](http://msys2.github.io/)（[笔记](../msys2/index.md)）

## 虚拟机

- [VirtualBox](https://www.virtualbox.org/wiki/Downloads) （[笔记](../virtualbox/index.md)）
